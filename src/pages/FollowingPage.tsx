            ...
            <div key={u.id} style={{
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {/* Mutual marker (095). Quiet on purpose: it is context for
                      the row, not a second thing to read. */}
                  {u.follows_you && (
                    <span style={{
                      display: 'inline-block', marginTop: 3,
                      fontFamily: FONT_UI, fontWeight: 800, fontSize: 8.5,
                      letterSpacing: '0.12em', textTransform: 'uppercase', color: FAINT,
                      border: '1px solid rgba(240,228,200,0.16)', padding: '2px 5px',
                    }}>Follows you</span>
                  )}
                </div>
              </div>
