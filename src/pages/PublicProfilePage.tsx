...
const TEMPLATES: Record<number, Template> = {
  ...
  3: {
    ...
    edges: [
      // Roads exit from the LOWER body of the Garage icon (≈33px to the side,
      // ≈18px below centre) — over the wide opaque walls of the house glyph,
      // never its narrow/transparent mid-height edges. Matches the Home map's
      // garage origins exactly (centre 195,220 → starts 228,238 / 162,240).
      // Garage centre here is 195,253, so +18 down = ~271/273.
      { a: 0, b: 1, bend: 0,
        pathFn: () => `M 228 271 C 370 300, 36 450, 300 445` },
      { a: 0, b: 2, bend: 0,
        pathFn: () => `M 162 273 C 20 283, 10 368, 14 445 C 18 502, 50 528, 62 535` },
      { a: 1, b: 2, bend: 0,
          ...
          <svg viewBox="0 0 390 800" preserveAspectRatio="none"
            ...
            {nodes.length === 3 && (
              <g fontFamily="Cormorant Garamond, serif" fontStyle="italic" fontSize="10"
                ...
                <path id="pub-3-a" d="M 228 271 C 370 300, 36 450, 300 445" fill="none"/>
                <text><textPath href="#pub-3-a" startOffset="14%">To Build Sheet</textPath></text>
                <path id="pub-3-b" d="M 62 535 C 50 528, 18 502, 14 445 C 10 368, 20 283, 162 273" fill="none"/>
