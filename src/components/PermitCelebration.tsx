  ...
  return (
    ...
    >
      <style>{`
        ...
        @keyframes permitCardIn { 0% { opacity: 0; transform: scale(0.9); } 100% { opacity: 1; transform: scale(1); } }
      ...
      {!reduced && (
        <div style={{
          ...
          animation: 'permitBeam 2200ms cubic-bezier(0.22,1,0.36,1) both',
        }} />
      )}
      ...
      <div style={{
        ...
        animation: reduced ? undefined : 'permitSpot 2200ms cubic-bezier(0.22,1,0.36,1) both',
      }} />
      ...
      <div style={{
        ...
        animation: reduced ? undefined : 'permitFadeUp 1400ms cubic-bezier(0.22,1,0.36,1) 700ms both',
      }}>
        {kicker}
      ...
      <div style={{
        ...
        animation: reduced ? undefined : 'permitCardIn 2400ms cubic-bezier(0.22,1,0.36,1) 500ms both',
      }}>
        <LicenseCard
      ...
      <div style={{
        ...
        animation: reduced ? undefined : 'permitFadeUp 1200ms ease 2600ms both, permitBreathe 3s ease-in-out 3800ms infinite',
      }}>
