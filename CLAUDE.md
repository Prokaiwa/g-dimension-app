...
`supabase/migrations/001_users.sql` → `062_tutorial_seen.sql` — run in order.
...
supabase/migrations/                — Numbered SQL files 001–062
