...
`supabase/migrations/001_users.sql` → `068_sound_music_prefs.sql` — run in order.
...
supabase/migrations/                — Numbered SQL files 001–068
